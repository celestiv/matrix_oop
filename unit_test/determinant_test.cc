...
TEST(MatrixTest, DetMatrix3x3) {
  s21::S21Matrix matrix(3, 3);
  matrix(0, 0) = 1.0;
  matrix(0, 1) = 32.12;
  matrix(0, 2) = 432.12;
  matrix(1, 0) = 2.32;
...
TEST(MatrixTest, DetMatrix4x4) {
  s21::S21Matrix matrix(4, 4);
  matrix(0, 0) = 1.0;
  matrix(0, 1) = 5.2;
  matrix(0, 2) = 2.6;
  matrix(0, 3) = 7.2;
